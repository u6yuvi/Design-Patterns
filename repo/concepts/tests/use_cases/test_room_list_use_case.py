...
from concepts.domain import room as r
...
def domain_rooms():
    ...
    room_3 = r.Room(
        code=uuid.uuid4(), size=56, price=60, longitude=0.27891577, latitude=51.45994069
    )
    room_4 = r.Room(
        code=uuid.uuid4(), size=93, price=48, longitude=0.33894476, latitude=51.39916678
    )
